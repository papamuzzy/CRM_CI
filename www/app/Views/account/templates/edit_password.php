...
<?= $this->section('content') ?>
                ...
                <div class="login_form_bi_f">
                    <div class="login_form_tt">
                        <div class="login_form_logo">
                            <img src="<?= base_url("img/login-crtacc-logo.svg") ?>"
                                 title="Freedom Code Compliance - Change Password" width="175">
                        </div>
                    ...
                    <div id="login-form-auth" class="login_form_auth">
                        <?php if (!empty($form_anchor) and is_string($form_anchor)) : ?>
                            <?= form_open($form_anchor, ['id' => 'form-login-create', 'class' => 'form_login_auth', 'autocomplete' => 'off']) ?>
                            <div class="row form_row">
                                <div class="col form_col">
                                    <label for="input-pass" class="form-label">Create New Password</label>
                                    <span data-toggle="input-pass"
                                          class="span_ico_el toggle_password_icon toggle_password_icon_hd"></span>
                                    <input type="password" id="input-pass" name="password"
                                           class="form-control form_input form_input_pass <?= (!empty($validation['password']) ? 'inp_invalid' : '') ?>"
                                           placeholder="Password" aria-label="Password" maxlength="50"
                                           pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                            ...
                            <div class="row form_row">
                                <div class="col form_col">
                                    ...
                                    <span data-toggle="input-pass-confirm"
                                          class="span_ico_el toggle_password_icon toggle_password_icon_hd"></span>
                                    <input type="password" id="input-pass-confirm" name="confirm_password"
                                           class="form-control form_input form_input_pass <?= (!empty($validation['confirm_password']) ? 'inp_invalid' : '') ?>"
                                           placeholder="Confirm Password" aria-label="Confirm Password" maxlength="50"
                                           pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required value="">
                                ...
                                <div class="col form_col">
                                    <div id="message-passw-check" class="message_passw_check">
                                        ...
                                        <div class="message_passw_check_ds">
                                            <span id="message-letter-check"
                                                  class="message_passw_lbl message_passw_invalid">A lowercase letter</span>
                                            <span id="message-capital-check"
                                                  class="message_passw_lbl message_passw_invalid">A capital (uppercase) letter</span>
                                            <span id="message-number-check"
                                                  class="message_passw_lbl message_passw_invalid">A number</span>
                                            <span id="message-length-check"
                                                  class="message_passw_lbl message_passw_invalid">Minimum 8 characters</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js"
            ...
            crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/i18n/en.min.js"
            integrity="sha512-IS4cS3xCf0ASMwMgYwIo/fiAz3UCorMca4XSHGAEIvd/Qzy0SBez7HtLrKrjzGdKjAwPBS0B7yEi3zxVIcCXKA=="
            crossorigin="anonymous" referrerpolicy="no-referrer"></script>
