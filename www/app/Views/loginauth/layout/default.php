...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url("css/login-main.css") ?>" rel="stylesheet">
    <link href="<?php echo base_url("css/login-auth.css") ?>" rel="stylesheet">
  </head>
  <body>
    ...
    <script src="<?php echo base_url("js/login-auth.js") ?>"></script>
</body>
</html>